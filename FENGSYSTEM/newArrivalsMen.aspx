<%@ Page Title="" Language="C#" MasterPageFile="~/masterPage.Master" AutoEventWireup="true" CodeBehind="newArrivalsMen.aspx.cs" Inherits="FENGSYSTEM.newArrivalsMen" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <form runat="server">
        <div class="container  d-flex justify-content-start align-content-center">
            <asp:DataList ID="dl_newmen" runat="server" RepeatColumns="3">
                <ItemTemplate>
